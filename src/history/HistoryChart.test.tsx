...
it("updates status from pointer movement and names the selected range", () => { render(<HistoryChart points={[point]} range="7d" />); const button = screen.getByRole("button", { name: /25%/i }); fireEvent.mouseMove(button); expect(screen.getByRole("img", { name: /7 day usage history/i })).toBeTruthy(); expect(screen.getAllByRole("status")[0].textContent).toContain("Claude, 25%"); });
